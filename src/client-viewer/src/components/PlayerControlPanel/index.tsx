...
interface PlayerControlPanelProps {
  ...
  isVideoFlippedH: boolean;
  setIsVideoFlippedH: (flipped: boolean) => void;
  isVideoFlippedV: boolean;
  setIsVideoFlippedV: (flipped: boolean) => void;
...
function PlayerControlPanel(props: PlayerControlPanelProps) {
  ...
  const handleFlipHClick = useCallback(() => {
    setIsVideoFlippedH(!isVideoFlippedH);
  }, [isVideoFlippedH, setIsVideoFlippedH]);

  const handleFlipVClick = useCallback(() => {
    setIsVideoFlippedV(!isVideoFlippedV);
  }, [isVideoFlippedV, setIsVideoFlippedV]);
                      ...
                      <>
                        ...
                        <Row style={{
                          ...
                          <Button
                            ...
                            minimal
                            active={isVideoFlippedH}
                            style={videoQualityButtonStyle}
                            onClick={handleFlipHClick}
                          >
                            {t('Flip Horizontal')}
                          </Button>
                        </Row>
                        ...
                        <Row style={{
                          ...
                          <Button
                            icon='swap-vertical'
                            minimal
                            active={isVideoFlippedV}
                            style={videoQualityButtonStyle}
                            onClick={handleFlipVClick}
                          >
                            {t('Flip Vertical')}
                          </Button>
                        </Row>
